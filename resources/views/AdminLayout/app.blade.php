                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('product_list') }}" class="nav-link" data-key="t-calendar"> Product List </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('orders') }}" class="nav-link" data-key="t-calendar"> Orders </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('add_category') }}" class="nav-link" data-key="t-calendar"> Add Category </a>
                                    </li>
