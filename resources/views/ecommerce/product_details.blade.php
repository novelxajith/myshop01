                                ...
                                <div class="inner">
                                    ...
                                    <div class="product-action-wrapper">
                                        ...
                                        <ul class="product-action d-flex-center mb--0">
                                            <li class="add-to-cart"><a href="{{route('checkout')}}" class="axil-btn btn-bg-secondary"><i class="far fa-shopping-bag"></i> Buy Now</a></li>
                                            <li class="add-to-cart"><a href="{{route('cart')}}" class="axil-btn btn-bg-primary"><i class="far fa-shopping-cart"></i> Add to Cart</a></li>
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="pro-des-features">
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="ecommerce/images/product/product-thumb/icon-3.png" alt="icon">
                                                </div>
                                                Easy Returns
                                            </li>
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="ecommerce/images/product/product-thumb/icon-2.png" alt="icon">
                                                </div>
                                                Quality Service
                                            </li>
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="ecommerce/images/product/product-thumb/icon-1.png" alt="icon">
                                                </div>
                                                Original Product
                                            </li>
                                        </ul>
                                            ...
                                            <ul class="comment-list">
                                                    ...
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="ecommerce/images/blog/author-image-4.png" alt="Author Images">
                                                            </div>
                                                ...
                                                <li class="comment">
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="ecommerce/images/blog/author-image-5.png" alt="Author Images">
                                                            </div>
                                                            <div class="comment-inner">
                                                                <h6 class="commenter">
                                                                    <a class="hover-flip-item-wrapper" href="#">
