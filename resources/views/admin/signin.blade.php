                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <!-- <img src="{{config('app.assets2')}}images/logo-light.png" alt="" height="20"> -->
                                </a>
                            </div>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation"  action="{{route('admin_login')}}" method="POST">
@csrf
                                        <div class="mb-3">
                                            <label for="useremail" class="form-label">Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control" value="test@gmail.com" name="email" id="useremail" placeholder="Enter email address" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" value="1234" name="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" id="password-input" aria-describedby="passwordInput" >
    ...
    <!-- particles js -->
    <script src="{{config('app.assets2')}}libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script src="{{config('app.assets2')}}js/pages/particles.app.js"></script>
    <!-- validation init -->
    <script src="{{config('app.assets2')}}js/pages/form-validation.init.js"></script>
    <!-- password create init -->
    <script src="{{config('app.assets2')}}js/pages/passowrd-create.init.js"></script>
</body>
