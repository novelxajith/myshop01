                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" class="form-control" id="product-title-input" value="" placeholder="Enter product title" >
...
<script>
        ...
        myInput.addEventListener("keydown", function (event) {
            ...
            if (event.keyCode === 13) {
                ...
                console.log("Enter key pressed, but page reload prevented");
            }
        });
    </script>
